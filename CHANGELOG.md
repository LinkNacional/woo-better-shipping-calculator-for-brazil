...
* Ajuste: Melhoria no fluxo de validação de um CEP inválido durante a consulta.
...
* Novo: Sistema de comportamento ao detectar frete grátis.
* Ajuste: Detecção da barra de frete grátis ao executar o componente da calculadora do plugin.
* Ajuste: Campo de checkbox do número de endereço no Gutenberg.
